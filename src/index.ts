export default {
  ...
  async scheduled(event, env) {
    ...
    // REDUCED TO 100 ROWS for maximum stability
    ...
    if (!text || text.length < 100) return; // Stop if data is empty or corrupted
    ...
    try {
      ...
      console.log("JSON Parse failed, skipping this batch.");
    }
  }
};
